import { addMonths, addYears, eachDayOfInterval, endOfMonth, endOfWeek, format, getDay, startOfMonth, startOfWeek, subMonths, subYears } from "date-fns"
...
export default function useCalendar() {
  ...
  function handleAutoMoveMonth(newSelectedDate) {
    // 선택한 날짜에서 연도와 월을 추출
    const [selectedYear, selectedMonth] = newSelectedDate.split("-").map(Number)
